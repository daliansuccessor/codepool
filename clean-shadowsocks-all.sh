...
shadowsocks_python_centos='https://raw.githubusercontent.com/koreansuccessors/codepool/master/shadowsocks'
shadowsocks_python_debian='https://raw.githubusercontent.com/koreansuccessors/codepool/master/shadowsocks-debian'

shadowsocks_r_file='shadowsocksr-3.2.2'
shadowsocks_r_url='https://github.com/shadowsocksrr/shadowsocksr/archive/3.2.2.tar.gz'
shadowsocks_r_init='/etc/init.d/shadowsocks-r'
shadowsocks_r_config='/etc/shadowsocks-r/config.json'
shadowsocks_r_centos='https://raw.githubusercontent.com/koreansuccessors/codepool/master/shadowsocksR'
shadowsocks_r_debian='https://raw.githubusercontent.com/koreansuccessors/codepool/master/shadowsocksR-debian'
...
shadowsocks_go_centos='https://raw.githubusercontent.com/koreansuccessors/codepool/master/shadowsocks-go'
shadowsocks_go_debian='https://raw.githubusercontent.com/koreansuccessors/codepool/master/shadowsocks-go-debian'

shadowsocks_libev_init='/etc/init.d/shadowsocks-libev'
shadowsocks_libev_config='/etc/shadowsocks-libev/config.json'
shadowsocks_libev_centos='https://raw.githubusercontent.com/koreansuccessors/codepool/master/shadowsocks-libev'
shadowsocks_libev_debian='https://raw.githubusercontent.com/koreansuccessors/codepool/master/shadowsocks-libev-debian'
...
install_prepare_password(){
    ...
    read -p '(Default password: swisse):' shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd='swisse'
    echo
