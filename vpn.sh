...
preinstall_l2tp(){
    ...
    read -p "(Default PSK: lunfansuo):" mypsk
    [ -z ${mypsk} ] && mypsk="lunfansuo"

    echo "Please enter Username:"
    read -p "(Default Username: lunfansuo):" username
    [ -z ${username} ] && username="lunfansuo"
